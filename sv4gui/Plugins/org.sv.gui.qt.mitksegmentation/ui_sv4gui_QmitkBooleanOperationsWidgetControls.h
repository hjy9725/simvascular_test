/********************************************************************************
** Form generated from reading UI file 'sv4gui_QmitkBooleanOperationsWidgetControls.ui'
**
...
#ifndef UI_SV4GUI_QMITKBOOLEANOPERATIONSWIDGETCONTROLS_H
#define UI_SV4GUI_QMITKBOOLEANOPERATIONSWIDGETCONTROLS_H
...
public:
    ...
    void retranslateUi(QWidget *QmitkBooleanOperationsWidgetControls)
    {
        ...
        differenceButton->setToolTip(QApplication::translate("QmitkBooleanOperationsWidgetControls", "Subtracts first segmentation from the second one", nullptr));
#endif // QT_NO_TOOLTIP
        differenceButton->setText(QApplication::translate("QmitkBooleanOperationsWidgetControls", "Difference", nullptr));
#ifndef QT_NO_TOOLTIP
        intersectionButton->setToolTip(QApplication::translate("QmitkBooleanOperationsWidgetControls", "Keeps just the overlapping areas of two the segmentations", nullptr));
#endif // QT_NO_TOOLTIP
        intersectionButton->setText(QApplication::translate("QmitkBooleanOperationsWidgetControls", "Intersection", nullptr));
#ifndef QT_NO_TOOLTIP
        unionButton->setToolTip(QApplication::translate("QmitkBooleanOperationsWidgetControls", "Combines the two segmentations", nullptr));
#endif // QT_NO_TOOLTIP
        unionButton->setText(QApplication::translate("QmitkBooleanOperationsWidgetControls", "Union", nullptr));
...
#endif // UI_SV4GUI_QMITKBOOLEANOPERATIONSWIDGETCONTROLS_H
